...
import { Link } from "../library"; // Asegúrate de importar el componente Link de tu biblioteca
  ...
  return (
    <div>
      ...
      <div className="border-solid border border-black p-3">
        ...
        {selectedMarker &&
        parking?.confirmations.includes(user.id) ? (
          <div className="flex items-center mb-4">
        ...
        <div className="flex items-center justify-start mb-4">
          ...
          {user.role === "User" &&
            parking &&
            parking.locator.id === user.id &&
            parking.confirmations.length === 0 && (
              <button className="bg-blue-500 text-white px-2 py-1 rounded">
                Eliminar Parking
              </button>
            )}
