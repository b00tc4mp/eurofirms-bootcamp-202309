...
const validate = {
    ...
    password(password, explain) {
        ...
        if (password.length < 8) throw new RangeError(explain + ' password length is less than 8')
    },
    ...
    id(id, explain) {
        if (!isValidObjectId(id)) throw new TypeError(explain + ' is not a valid object')
    }
}
