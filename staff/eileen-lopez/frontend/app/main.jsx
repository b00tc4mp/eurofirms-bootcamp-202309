...
function Register() {
    return <div className="view">
        ...
        <form id="register-form" className="form">
            ...
            <label className="input" type="email" id="name-input" title="Name" required></label>

            <label className="label" htmlFor="email-input">E-mail</label>
            <input className="input" type="email" id="email-input" title="E-mail" required></label>

            <label className="label" htmlFor="password-input">Password</label>
            <input className="input" type="password" id="password" title="Password" required></input>
