...
// Definimos una función llamada retrieveSavedPosts que recibe una función de devolución de llamada (callback)
function retrieveSavedPosts(callback) {
    ...
    // Realizamos una solicitud al servidor para obtener todos los posts guardados del usuario
    ...
    .then(res => {
        ...
        // Si la respuesta es exitosa, procesamos el cuerpo JSON para obtener todos los posts guardados del usuario
        res.json()
...
// Exportamos la función retrieveSavedPosts para que pueda ser utilizada en otras partes del código
