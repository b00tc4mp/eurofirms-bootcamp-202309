...
// Definimos una función llamada toggleLikePost que recibe el identificador de un post y una función de devolución de llamada (callback)
function toggleLikePost(postId, callback) {
    ...
    // Realizamos una solicitud al servidor para cambiar el estado "me gusta" de un post
...
// Exportamos la función toggleLikePost para que pueda ser utilizada en otras partes del código
