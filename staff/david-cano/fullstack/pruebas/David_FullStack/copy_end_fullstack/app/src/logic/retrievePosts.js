...
// Definimos una función llamada retrievePosts que recibe una función de devolución de llamada (callback)
function retrievePosts(callback) {
    ...
    // Realizamos una solicitud al servidor para obtener todos los posts
    fetch(`${import.meta.env.VITE_API_URL}/posts`, req)
        .then(res => {
            ...
            // Si la respuesta es exitosa, procesamos el cuerpo JSON para obtener todos los posts
            res.json()
...
// Exportamos la función retrievePosts para que pueda ser utilizada en otras partes del código
