...
// Exporta una función que maneja la recuperación de las propias publicaciones de un usuario cuando llega una solicitud HTTP
module.exports = (req, res) => {
    try {
        ...
        // Llama a la función 'retrieveMyPosts' de la lógica de negocio para recuperar las publicaciones del usuario
