function Logo() {
    ...
    const aguaRelaxRef = React.useRef()

    function handleMouseOverLogo() {

        aguaRelaxRef.current.play()
    }
    return <div>
        <svg version="1.1"
            width="30" height="30" xmlns="http://www.w3.org/2000/svg" onMouseOver={handleMouseOverLogo}>
        ...
        <audio id="agua-relax" controls ref={aguaRelaxRef}>
            <source src="https://cdn.freesound.org/previews/688/688450_14346318-lq.ogg" type="audio/ogg" />
            <source src="https://cdn.freesound.org/previews/688/688450_14346318-lq.mp3" type="audio/mpeg" />
        </audio>
