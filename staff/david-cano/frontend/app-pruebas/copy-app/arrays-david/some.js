...
function some(array, callback) {
    ...
    for (var i = 0; i < array.length; i++) {
        ...
        if (result) {
            // Paso 5: Si "result" es verdadero (true), significa que se ha encontrado al menos un elemento que cumple la condición, por lo que retornamos true y la función some termina.
            return true;
        }
    }
    // Paso 6: Si no se encuentra ningún elemento que cumple la condición después de iterar por todo el array, la función some termina y retorna false.
    return false;
}
