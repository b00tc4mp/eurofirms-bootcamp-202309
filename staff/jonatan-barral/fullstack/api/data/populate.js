...
mongoose.connect('mongodb://127.0.0.1:27017/test').then(() => {
    const pepito = new User({ name: 'Pepito Grillo', email: 'pepito3@grillo.com', password: '123123123' })

    pepito.saved.push(new ObjectId('6564c1cb62684fff5d0bd23a'))

    pepito.save().then(() => console.log('user created and updated'))
