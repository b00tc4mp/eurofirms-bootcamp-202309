...
// prevenimos que cargue la página por defecto
...
// declaramos 3 variables para recoger el valor de los inputs nombre, email y contraseña introducidos por el usuario
...
for (var i = 0; i < users.length; i++) {
  ...
  // si la variable usuario encontrado no es nula, te dice que las credenciales son erroneas
