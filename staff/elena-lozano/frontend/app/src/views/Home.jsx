...
function Home(props) {
    ...
    return <div>
        ...
        {view === "new-post" ? <div className="aNewPost-view">
            <h2>New post</h2>
        ...
        {(view === null || view === "new-post") && posts !== null ? <div aria-label="Posts list" className="home-view">
        ...
        {view === "saved" && saved !== null ? <div aria-label="Saved list" className="savedPosts-view">
